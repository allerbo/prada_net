...
df = pd.read_csv('logs/lbda_sweep_09_17_41.txt',sep=';',names=['boot_seed','opt_seed', 'lbda','mse'])
...
ax.text(lbda_star-.7,min_mean+0.001,'($\lambda^*$, min(MSE)')
ax.set_ylim([0,0.06])
plt.savefig('figures/select_lbda.pdf')
