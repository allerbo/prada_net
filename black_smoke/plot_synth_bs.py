...
TOT=True
for my_fcts_TOT in [['0','1','2','8','9'],['0','1','2','8','9','1-4','4-1','8-9', '9-8','8-9-10']]:
  for my_fct1 in my_fcts_TOT:
    ...
    for x2_value in bins2:
      for x3_value in bins3:
        ...
        ii+=1
    if my_fct1=='4-1' or my_fct1=='9-8' or my_fct1=='8-9-10':
      ii+=1
  TOT=False
...
plt.savefig('figures/bs_fcts.pdf')
